...
class EloquentSubscriptionRepository implements SubscriptionRepository
{
    ...
    public function create($organization_id, array $input)
    {
        $subscription = Subscription::updateOrCreate([
            ...
            'last_four'         => isset($input['card']) ? $input['card']['last4'] : null,
            'card_type'         => isset($input['card']) ? ucfirst($input['card']['card_type']) : null,
            'expiry_month'      => isset($input['card']) ? $input['card']['expiry_month'] : null,
            'expiry_year'       => isset($input['card']) ? $input['card']['expiry_year'] : null,
